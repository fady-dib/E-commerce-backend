...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2023 at 11:24 PM
...
ALTER TABLE `categories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_product_category` (`id_product`);
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `id_product_category` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
